...
%DIF ADD mainos.tex       Thu Feb 20 11:44:17 2020
%% ---------------------------------
...
\caption{Depths of the model vertical $\sigma$-levels along a section in the \DIFdelbeginFL \DIFdelFL{Irminger Basin }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Labrador Sea }\DIFaddendFL for (a) the 6-km simulation (NATL), and (b) the 2-km simulation (POLGYR) \DIFaddbeginFL \DIFaddFL{and (c) the vertical grid spacing with depth along the black line shown in (b)}\DIFaddendFL . }
\label{f02}
\end{figure} 
