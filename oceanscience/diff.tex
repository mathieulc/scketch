...
%DIF ADD mainos.tex       Mon Feb 17 18:43:39 2020
%% ---------------------------------
...
The vertical mixing of tracers and momentum is done by a k-$\epsilon$ model (GLS, \citet{umlauf2003}). The effect of bottom friction is parameterized through a logarithmic law of the wall with a roughness length $Z_{0} = 0.01$ m. \DIFaddbegin \DIFadd{We use no explicit viscosity or diffusivity as the numerical scheme induces sufficient duffusion. 
}\DIFaddend 
...
\DIFdelbegin \DIFdel{The barotropic vorticity equation is obtained by integrating the momentum equations in the vertical and }\DIFdelend \DIFaddbegin \DIFadd{Two barotropic vorticity equations can be obtained depending on the choice of vertically integrating or averaging the momentum equations before }\DIFaddend cross-differentiating \DIFdelbegin \DIFdel{them }\DIFdelend \DIFaddbegin \DIFadd{them. The vertical averaging method allows to define the main components driving the flow across f/h contours. On the other hand, the vertically integrated momentum equations give more informations on what is driving the barotropic flow. This last definition will be used in the following and can be written as }\DIFaddend \citep{gula2015}:
